...
<head>
  ...
  <title>Cloth Online Shopping</title>
  <meta charset="utf-8">
...
<form method='post'>
	...
	if(isset($_POST['adminlogin']))
	{
		 $uname=$_POST['auname'];
		   ...
		   if(empty($uname)||empty($pass))
			   ...
			   {
	   $sel="select * from admin where id='$uname' and pass='$pass'";
	   $result=$con->query($sel);
			...
			if($row=mysqli_fetch_array($result))				
		   {
					...
					$aid= $_SESSION['aid'];
					$_SESSION['type']="admin";
					echo "<script>window.location.href='prodEntry.php'</script>";  
			}
			else
			{
		...
		if(isset($_POST['stulogin']))
	{
	   ...
	   $sel="select * from users where username='$uname1' and password='$pass1'";
	   $result=$con->query($sel);
...
<br><br><br><br>
  <img src="images/logo.jpg" class="img-responsive img-circle margin" style="display:inline;height:300px"   width="550" >
<h4>Online Shopping</h4><br><br>
  </div>
...
<footer class="text-center">
  <p align='right'><a href="#" data-toggle="tooltip" title="">Cloth Online Shopping</a></p> 
</footer>
